...
export class ProductoComponent {
  ...
  private apiUrl = 'https://mean-election-candle-joint.trycloudflare.com/api/productos';
  private categoriaUrl = 'https://mean-election-candle-joint.trycloudflare.com/api/categorias';
  private stockUrl = 'https://mean-election-candle-joint.trycloudflare.com/api/stock';
